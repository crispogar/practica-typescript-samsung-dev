...
const direccion1 = new direccion_1.direccion('Avenida de la Lavanda', '14', '1', 'D', '29539', 'Arcoiris', 'Colorandia');
const direccion1Array = direccion1.getDireccionArray();
const mail1 = new mail_1.mail('Personal', 'violetasmail@colorandia.es');
const mail1Array = mail1.getMailArray();
const telefono1 = new telefono_1.telefono('Privado', '123456789');
const telefono1Array = telefono1.getTelefonoArray();
const persona1 = new persona_1.persona('Violeta', 'Morado Púrpura', '28', '12345678A', '08-04-1995', 'Violeta', 'Mujer', direccion1Array.toString(), mail1Array.toString(), telefono1Array.toString(), 'Disponible 24/7');
/*Persona 2.*/
const direccion2 = new direccion_1.direccion('Calle del Río Bravo', '10', '2', 'A', '29538', 'Arcoiris', 'Colorandia');
const direccion2Array = direccion2.getDireccionArray();
const mail2 = new mail_1.mail('Personal', 'celestesmail@colorandia.es');
const mail2Array = mail2.getMailArray();
const telefono2 = new telefono_1.telefono('Empresarial', '234567891');
const telefono2Array = telefono2.getTelefonoArray();
const persona2 = new persona_1.persona('Celeste', 'Azul Marino', '40', '23456789B', '27-01-1983', 'Azul', 'Hombre', direccion2Array.toString(), mail2Array.toString(), telefono2Array.toString(), 'Molestar si es urgente');
/*Persona 3.*/
const direccion3 = new direccion_1.direccion('Travesía de la Rosa salvaje', '13', '5', 'C', '29537', 'Arcoiris', 'Colorandia');
const direccion3Array = direccion3.getDireccionArray();
const mail3 = new mail_1.mail('Personal', 'rosasmail@colorandia.es');
const mail3Array = mail3.getMailArray();
const telefono3 = new telefono_1.telefono('Personal', '345678912');
const telefono3Array = telefono3.getTelefonoArray();
const persona3 = new persona_1.persona('Rosa', 'Fucsia Magenta', '18', '34567891C', '25-03-2005', 'Rosa', 'Mujer', direccion3Array.toString(), mail3Array.toString(), telefono3Array.toString(), 'Nunca sabe dónde tiene el móvil');
...
function actualizarPersonaPorDNI(agenda, dni, direccionNueva, telefonoNuevo, mailNuevo) {
...
todo completo.*/
const direccionNueva = new direccion_1.direccion('Glorieta del Jacinto', '20', '5', 'B', '29539', 'Arcoiris', 'Colorandia');
const direccionNuevaArray = direccionNueva.getDireccionArray();
const mailNuevo = new mail_1.mail('Privado', 'violetasdeverdadmail@colorandia.es');
const mailNuevoArray = mailNuevo.getMailArray();
const telefonoNuevo = new telefono_1.telefono('Privado', '123456799');
const telefonoNuevoArray = telefonoNuevo.getTelefonoArray();
/*Actualizamos la agenda con los nuevos campos.*/
actualizarPersonaPorDNI(agenda, "12345678A", direccionNuevaArray.toString(), mailNuevoArray.toString(), telefonoNuevoArray.toString());
